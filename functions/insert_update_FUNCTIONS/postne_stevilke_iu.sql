create or replace function postne_stevilke_iu(i_id_postne_stevilke integer, i_postna_stevilka character varying,
                                            i_kraj_mesto character varying, i_id_drzave integer)
RETURNS integer as
$$
    DECLARE
        kljuc integer;
